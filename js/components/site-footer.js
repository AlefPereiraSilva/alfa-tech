      ...
      <div class='footer'>
        <div class='footer__container'>
          <div class='footer__brand-wrapper'>
            <a href='#home'>
              <img class='footer__brand' src='./assets/images/logo3.png' alt='logo'>
            </a>
            <p class='footer__slogan'>Inovando o Agora</p>
          </div>
          <nav class='footer__nav'>
            <a href='#contato' class='footer__link'>Inscreva-se</a>
          ...
          <div class='footer__social'>
            ...
            <a href='#' aria-label='Linkedin' class='footer__social-link'>
              <img src='./assets/icons/linkedin.png' alt='icon_linkedin' class='footer__icon'>
            </a>
            <a href='#' aria-label='GitHub' class='footer__social-link'>
              <img src='./assets/icons/github.png' alt='icon_github' class='footer__icon'>
            </a>
            <a href='#' aria-label='WhatsApp' class='footer__social-link'>
              <img src='./assets/icons/whatsapp.png' alt='icon_whatsapp' class='footer__icon'>
            </a>
          </div>
        </div>
      </div>
